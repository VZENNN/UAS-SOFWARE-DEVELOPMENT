...
use App\Http\Controllers\Client\OngkirController;
...
Route::get('/provinces', [OngkirController::class, 'getAllProvinces']);
Route::get('/cities/{id}', [OngkirController::class, 'getCitiesByProvince']);
Route::get('/ongkir/services', [OngkirController::class, 'getOngkirServices']);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(DiscountController::class)->group(function() {
        Route::get('/discount', 'index')->name('admin.discount.index');
