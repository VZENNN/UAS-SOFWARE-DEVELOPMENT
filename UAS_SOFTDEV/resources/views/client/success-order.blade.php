    ...
    <x-organisms.navbar :path="$shop->path"/>
        <div class="container py-y d-flex flex-column align-items-center gap-3">
            ...
            <div class="text-center">
                ...
                <p>Anda selalu dapat melacak pesanan Anda di <a href="{{ route('clientCheckOrder') }}"><u>Cek Pesanan</u></a>, harap simpan dan jangan lupa kode ini untuk memeriksa status pesanan.</p>
            </div>
