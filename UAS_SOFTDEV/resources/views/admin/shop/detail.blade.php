                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_shop" id="name_shop" class="form-control  @error('name_shop') is-invalid @enderror" placeholder="Elektronika" value="{{ $shop->name_shop }}" required autofocus>
                            @error('name_shop')
