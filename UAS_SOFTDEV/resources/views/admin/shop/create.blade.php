                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_shop" id="name_shop" class="form-control  @error('name_shop') is-invalid @enderror" placeholder="Elektronika" value="{{old('name_shop')}}" required autofocus>
                                    @error('name_shop')
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea name="desc" id="desc" cols="30" class="form-control @error('desc') is-invalid @enderror" placeholder="Kami menjual . . .">{{ old('desc') }}</textarea>
                                        @error('desc')
