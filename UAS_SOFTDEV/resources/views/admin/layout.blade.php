            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.discount.index') || request()->routeIs('admin.discount.index') ? 'active' : '' }}">
                        ...
                        <li class="sidebar-item has-sub mt-5">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalUpdatePassword">Ubah kata sandi</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{ route('logout') }}"
        ...
        <div class="modal fade" id="modalUpdatePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalUpdatePasswordLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUpdatePasswordLabel">Perbarui Kata Sandi</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('shopUpdatePassword') }}" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Kata Sandi Baru">
                            @error('password')
