...
@section('content')
            ...
            <div class="col-md-6 col-12">
                <form action="{{ route('productEditSave', ['product' => $product->title, 'id' => $product->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control  @error('title') is-invalid @enderror" placeholder="Chicken nugget pedas" value="{{ old('title') ? old('title') : $product->title }}" required>
                        @error('title')
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="desc" id="desc" cols="30" class="form-control autosize @error('desc') is-invalid @enderror" placeholder="Nugget ayam pedas buatan sendiri dengan ayam sehat . . ." required>{{ $product->desc }}</textarea>
                            @error('desc')
            ...
            <div class="col-md-6 col-12">
                <form method="post" action="{{route('productAddImagesSave')}}" enctype="multipart/form-data" class="dropzone mt-4" id="dropzone" style="border-radius:12px;">
                    ...
                    <div class="dz-message" data-dz-message>
                        <span>Unggah Galeri Produk</span><br>
    ...
    <div class="card">
        <div class="card-body">
            <a href="javascript:void(0)" onClick="deleteProduct('{{ route('productDelete', $product->id) }}')" class="btn btn-danger float-end">Hapus</a>
        </div>
    </div>
@endsection
@section('js')
